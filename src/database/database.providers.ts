...
import { FormDB } from 'src/src/api/form/entities/form.entity';
...
export const databaseProviders = [
    {
        ...
        useFactory: async (configService: ConfigService) => {
            ...
            sequelize.addModels([UserDB, UserTokenDB, UserSocketDB, UserPasswordDB, FormDB]);
